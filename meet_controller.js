...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  const muteButton = document.querySelector("[aria-label='Turn off microphone (ctrl + d)']")
  const unmuteButton = document.querySelector("[aria-label='Turn on microphone (ctrl + d)']")
